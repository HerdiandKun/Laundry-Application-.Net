...
Public Class CR_LaporanNonMember
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_LaporanNonMember.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_LaporanNonMember
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_LaporanNonMember = New CR_LaporanNonMember
        rpt.Site = Me.Site
        Return rpt
    End Function
